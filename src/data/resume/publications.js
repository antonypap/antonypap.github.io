const publications = [
  {
    ...
    authors: ['Buster Blackledge', 'Antonios Papaoikonomou', 'Matthew Scott', 'Asimina Mertzani', 'Noan Le Renard', 'Hazem Masoud', 'Jeremy Pitt'],
  ...
  },
  {
    ...
    authors: ['Antonios Papaoikonomou', 'James Wingate', 'Vasudha Verma', 'Aiden Durrant', 'George Ioannou', 'Tasos Papagiannis', 'Miao Yu', 'Georgios Alexandridis', 'Abdelhamid Dokhane', 'Georgios Leontidis', 'Stefanos Kollias', 'Andreas Stafylopatis'],
